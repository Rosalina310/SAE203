...
<body>
            ...
            <div class="page-content">
                ...
                <section class="actions-bar">
                    ...
                    <div class="actions-right">
                        ...
                        <button class="btn btn-primary" onclick="ouvrirModalNouvelAdherent()">
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <form class="form-container" id="formNouvelAdherent">
                    ...
                    <div class="form-group">
                        <label for="adresse" class="form-label">Adresse (optionnelle)</label>
                        <textarea name="adresse" id="adresse" class="form-textarea" rows="3" 
                                  placeholder="Adresse complète..."></textarea>
                    </div>

                    <div class="form-group">
                        <label for="commentaires" class="form-label">Commentaires (optionnel)</label>
                        <textarea name="commentaires" id="commentaires" class="form-textarea" rows="2" 
    ...
    <!-- Modal Profil Adhérent -->
    <div class="modal-overlay" id="modalProfilAdherent">
        <div class="modal modal-large">
            <div class="modal-header">
                <h3 class="modal-title" id="profilAdherentTitle">Profil de l'adhérent</h3>
                <button class="modal-close" onclick="fermerModal('modalProfilAdherent')">&times;</button>
            </div>
            <div class="modal-body">
                <div id="profilAdherentContent">
                    <!-- Contenu dynamique -->
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="fermerModal('modalProfilAdherent')">
                    Fermer
                </button>
                <button type="button" class="btn btn-primary" id="btnModifierDepuisProfil">
                    Modifier
                </button>
            </div>
        </div>
    ...
    <!-- Modal Emprunts Adhérent -->
    <div class="modal-overlay" id="modalEmpruntsAdherent">
        <div class="modal modal-large">
            <div class="modal-header">
                <h3 class="modal-title" id="empruntsAdherentTitle">Emprunts de l'adhérent</h3>
                <button class="modal-close" onclick="fermerModal('modalEmpruntsAdherent')">&times;</button>
            </div>
            <div class="modal-body">
                <div id="empruntsAdherentContent">
                    <!-- Contenu dynamique -->
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="fermerModal('modalEmpruntsAdherent')">
                    Fermer
                </button>
                <button type="button" class="btn btn-primary" onclick="creerNouvelEmpruntPour()">
                    Nouvel emprunt
                </button>
            </div>
        </div>
    ...
    <!-- Modal Modification Adhérent -->
    <div class="modal-overlay" id="modalModifierAdherent">
        <div class="modal">
            <div class="modal-header">
                <h3 class="modal-title">Modifier l'adhérent</h3>
                <button class="modal-close" onclick="fermerModal('modalModifierAdherent')">&times;</button>
            </div>
            <div class="modal-body">
                <form class="form-container" id="formModifierAdherent">
                    <input type="hidden" name="csrf_token" value="<?php echo generate_csrf_token(); ?>">
                    <input type="hidden" name="adherent_id" id="modifier_adherent_id">
                    
                    <div class="form-row">
                        <div class="form-group">
                            <label for="modifier_nom" class="form-label">Nom *</label>
                            <input type="text" name="nom" id="modifier_nom" class="form-input" required>
                        </div>
                        <div class="form-group">
                            <label for="modifier_prenom" class="form-label">Prénom *</label>
                            <input type="text" name="prenom" id="modifier_prenom" class="form-input" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="modifier_email" class="form-label">Email *</label>
                        <input type="email" name="email" id="modifier_email" class="form-input" required>
                    </div>

                    <div class="form-group">
                        <label for="modifier_statut" class="form-label">Statut</label>
                        <select name="statut" id="modifier_statut" class="form-select">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="fermerModal('modalModifierAdherent')">
                    Annuler
                </button>
                <button type="submit" form="formModifierAdherent" class="btn btn-primary">
                    Sauvegarder
                </button>
            </div>
        </div>
