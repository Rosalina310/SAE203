...
<body>
            ...
            <div class="page-content">
                ...
                <section class="actions-bar">
                    ...
                    <div class="actions-right">
                        ...
                        <button class="btn btn-primary" onclick="ouvrirModalNouveauMedia()">
                                            ...
                                            <td class="actions-cell">
                                                <div class="action-buttons">
                                                    <button class="btn-action btn-view" 
                                                            onclick="voirDetailsMedia(<?php echo $media['id']; ?>)"
                                                    ...
                                                    <button class="btn-action btn-exemplaires" 
                                                            onclick="gererExemplaires(<?php echo $media['id']; ?>)"
    ...
    <!-- Modal Gestion Exemplaires -->
    <div class="modal-overlay" id="modalGestionExemplaires">
        <div class="modal">
            <div class="modal-header">
                <h3 class="modal-title" id="exemplairesMediaTitle">Gestion des exemplaires</h3>
                <button class="modal-close" onclick="fermerModal('modalGestionExemplaires')">&times;</button>
            </div>
            <div class="modal-body">
                <div id="exemplairesContent">
                    <!-- Contenu dynamique -->
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="fermerModal('modalGestionExemplaires')">
                    Fermer
                </button>
                <button type="button" class="btn btn-primary" onclick="ajouterExemplaire()">
